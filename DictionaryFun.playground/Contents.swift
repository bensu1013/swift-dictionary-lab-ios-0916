 ...
 */
var coolStates: [String : String] = [ "New York" : "Albany" , " Ohio" : "Columbus", "Florida" : "Tallahassee", "Georgia" : "Atlanta", "Kentucky" : "Frankfort"]
 ...
 */
var capital = coolStates["Florida"]
 ...
 */
var anotherCapital = coolStates["Pennsylvania"]
 ...
 */
coolStates["Pennsylvania"] = "Harrisburg"
 ...
 */
capital = coolStates["Pennsylvania"]
if let capital = capital {
    print("Pennsylvania's capital is \(capital)")
} else {
    print("I really don't actually know, I haven't studied maps in nearly a decade!")
}
 ...
 */
let state = "New York"
capital = coolStates[state]
if let capital = capital {
    print("The capital of \(state) is \(capital)")
} else {
    print("We live here! Get a grip, okay... fine maybe I forgot it for a bit too.")
}
 ...
 */
var bandsNStuff: [String : [String]] = [:]
bandsNStuff["Nirvana"] = ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"]
bandsNStuff["The Beatles"] = ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"]
bandsNStuff["The Breeders"] = ["Kim Deal", "Kelley Deal", " Josephine Wiggs", "Jim Macpherson"]
bandsNStuff["Pixies"] = ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]
 ...
 */
let bandName = "Pixies"
var bandMembers = bandsNStuff[bandName]
